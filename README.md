...
```bash
git clone https://github.com/Gojo-Bot/Gojo-Satoru
cd Gojo-Satoru
npm install
```
...
Editing Number Owner & session name in [`config.js`](https://github.com/Gojo-Bot/Gojo-Satoru/blob/master/config.js)
...
* [`Saweria`](https://saweria.co/Gojo-Bot)
